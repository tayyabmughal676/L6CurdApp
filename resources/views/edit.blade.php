  ...
  <body>
    ...
    <div class="container">
           <div class="row">
                 ...
                 <form action="/home/{{$editProject->id}}" method="post">
                  @csrf
                  @method('PATCH')
                         <div class="form-group">

                            <label for="">Name</label> 
                            <input id="" required value="{{$editProject->name}}" class="form-control" type="text" name="name">
                            
                            <label for="">Details</label>
                            <input id="" required value="{{$editProject->detail}}" class="form-control" type="text" name="detail">
